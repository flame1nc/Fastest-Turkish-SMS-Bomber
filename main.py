...
while True:
  ...
  print(Fore.LIGHTGREEN_EX + "{/} " + Style.RESET_ALL + "Yapımcı " +
        Fore.LIGHTBLUE_EX + Style.BRIGHT + "discord: zengeralpha\n\n" + Fore.RED + "{!} " + Style.RESET_ALL + "Asla bir sorumluluk kabul etmiyorum, YAPILAN TÜM EYLEMLER SİZE AİTTİR !!\n" + Style.RESET_ALL)
  ...
  if menu == 1:
    ...
    print(Fore.LIGHTYELLOW_EX + "İletişim bilgileri:\n\n" +
          Fore.LIGHTGREEN_EX +
          "Discord: zengeralpha | " +
          Fore.LIGHTGREEN_EX + "DC: discord.gg/lanvin - By ZengerAlpha")

    print(Fore.LIGHTGREEN_EX + "{/} " + Style.RESET_ALL + "Made by " +
          Fore.LIGHTMAGENTA_EX + Style.BRIGHT + "zengeralpha\n" +
          Style.RESET_ALL)
